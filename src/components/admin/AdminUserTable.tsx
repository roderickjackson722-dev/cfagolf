                ...
                <TableRow key={profile.id}>
                  ...
                  <TableCell>
                    {(profile as any).program_type === 'consulting' ? (
                      ...
                      <Badge className="bg-blue-100 text-blue-800 border-blue-300">Self-Paced Course</Badge>
                    ) : (
                      <Badge variant="outline" className="text-muted-foreground">No Program</Badge>
                    )}
                  </TableCell>
                  <TableCell>
            ...
            <div className="pt-4 border-t">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="digital">Self-Paced Online Course</SelectItem>
