        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-lg mx-auto">
            <Card className="relative overflow-hidden border-2 border-primary shadow-xl">
              ...
              <div className="pt-6">
                <span className="text-5xl font-bold text-foreground">$1,199.99</span><span className="text-primary">*</span>
          ...
          <div className="mt-24 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <Card className="p-4 text-center border-2 border-primary bg-primary/5">
                ...
                <p className="text-2xl font-bold text-primary">$1,199.99</p>
