...
export const presentationSlides: PresentationSlide[] = [
  ...
  },
  {
    ...
    speakerNotes: [
      ...
      "Membership ($299 one-time): full Client Portal — database, coach tracker, scholarship calc, etc.",
      "Consulting ($2,499 one-time): everything + 1-on-1 strategy with Rod, 12-module HS or 6-module Transfer program",
